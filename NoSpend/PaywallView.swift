...
struct PaywallView: View {
    ...
    private let benefits: [(String, String, String)] = [
        ("calendar", "Full history", "Scroll back through every month and edit any past day."),
        ("chart.bar.fill", "Slip analytics", "See total spent, slip days and your average slip."),
        ("rosette", "Achievement badges", "Earn badges at 3, 7, 14, 30, 60 and 100-day streaks."),
        ("square.and.arrow.up.fill", "Share your streak", "Export a clean streak card to share your progress.")
    ]
            ...
            ScrollView {
                VStack(spacing: 22) {
                    VStack(spacing: 8) {
                        ...
                        Text("NoSpend Pro").font(.largeTitle.weight(.heavy))
                    ...
                    VStack(spacing: 12) {
                        Button { Task { await buy() } } label: {
                            HStack {
                                ...
                                Text(working ? "Unlocking…" : "Unlock NoSpend Pro · \(store.displayPrice)")
                                    .font(.headline)
                            }
                        ...
                        Text("NoSpend never tracks you. Your data stays on your device.")
